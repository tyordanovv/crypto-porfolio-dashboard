use crate::{models::NewSentimentData, sentiment_repository::SentimentRepo, tests::establish_test_pool};
use chrono::NaiveDate;


fn create_record(date: (i32, u32, u32), value: f64) -> NewSentimentData {
    NewSentimentData {
        name: "RSI".to_string(),
